...
DESCRIPTOR = _descriptor.FileDescriptor(
  ...
  syntax='proto3',
  serialized_options=b'\n3com.v2ray.core.transport.internet.headers.wireguardP\001ZCgithub.com/v2fly/v2ray-core/v4/transport/internet/headers/wireguard\252\002/V2Ray.Core.Transport.Internet.Headers.Wireguard',
  create_key=_descriptor._internal_create_key,
  serialized_pb=b'\n1transport/internet/headers/wireguard/config.proto\x12/v2ray.core.transport.internet.headers.wireguard\"\x11\n\x0fWireguardConfigB\xae\x01\n3com.v2ray.core.transport.internet.headers.wireguardP\x01ZCgithub.com/v2fly/v2ray-core/v4/transport/internet/headers/wireguard\xaa\x02/V2Ray.Core.Transport.Internet.Headers.Wireguardb\x06proto3'
)
