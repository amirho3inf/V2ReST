...
_ENCRYPTIONSEED = _descriptor.Descriptor(
  name='EncryptionSeed',
  full_name='v2ray.core.transport.internet.kcp.EncryptionSeed',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  create_key=_descriptor._internal_create_key,
  fields=[
    _descriptor.FieldDescriptor(
      name='seed', full_name='v2ray.core.transport.internet.kcp.EncryptionSeed.seed', index=0,
...
_CONFIG = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='seed', full_name='v2ray.core.transport.internet.kcp.Config.seed', index=8,
